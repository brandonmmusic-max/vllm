...
class KernelResolutionFrozenError(RuntimeError):
    """Raised when trellismx_b12x is asked to resolve a new kernel after freeze."""
...
def raise_if_kernel_resolution_frozen(
    ...
    *,
    ...
    details = [f"trellismx_b12x kernel resolution is frozen; refusing {kind}"]
    ...
    details.append(
        "warm up this kernel shape before calling trellismx_b12x.freeze_kernel_resolution()"
    )

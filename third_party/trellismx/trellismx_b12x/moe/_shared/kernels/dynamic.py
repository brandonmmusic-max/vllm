...
from trellismx_b12x._lib.smem import make_smem_memrange_alias
from trellismx_b12x._lib.dense_gemm import (
    DenseGemmKernel,
...
from trellismx_b12x.moe._shared.kernels.mxfp6_moe import (
...
from trellismx_b12x.moe._shared.kernels.w4a8_trellis_decode import (
    _w4a8_had128_quad,
...
from trellismx_b12x.moe._shared.kernels.w4a8_phase1 import (
    W4A8MaterializedPhase1Kernel,
)
from trellismx_b12x.moe._shared.kernels.w4a8_phase2 import (
...
class MoEDynamicKernelBackend:
    ...
    def __init__(
        ...
        *,
        ...
        if self.p8_small_m:
            from trellismx_b12x.moe._shared.kernels.p8_small_m import P8SmallMPhase2Kernel
        ...
        if self.p8_grouped_m16:
            from trellismx_b12x.moe._shared.kernels.p8_grouped_m16 import P8GroupedM16FC1Kernel, P8GroupedM16FC2Kernel
            ...
            from trellismx_b12x.moe._shared.kernels.p8_coupled_prefill_fc1 import (
                P8CoupledPrefillFC1Kernel,
            )
            from trellismx_b12x.moe._shared.kernels.p8_coupled_prefill_fc2 import (
            ...
            from trellismx_b12x.moe._shared.kernels.p8_h128_fc1 import P8H128FC1Kernel
            self.materialized_phase1_kernel = P8H128FC1Kernel(
                full_coupled=self.p8_full_coupled,
                trellis_bits=trellis_bits,
            )
        elif self.p8_fc1_tile_n != 128:
            from trellismx_b12x.moe._shared.kernels.p8_narrow_fc1 import P8NarrowFC1Kernel

...
from trellismx_b12x._lib.compiler import KernelCompileSpec, compile as b12x_compile
from trellismx_b12x._lib.utils import get_max_active_clusters
from trellismx_b12x.moe._shared.kernels.dynamic import MoEDynamicKernelBackend
from trellismx_b12x.moe.fused_moe._impl import (
...
class P8NativeTPMoE:
    ...
    def _compile(self, materialized: bool, small_m: bool = False) -> _CompiledArm:
        ...
        if self.diagnostic_raw_fc1:
            ...
            from trellismx_b12x.moe._shared.kernels.p8_h128_fc1 import (
    ...
    def _compile_full_coupled_reducer(self):
        ...
        from trellismx_b12x.moe._shared.kernels.p8_coupled_topk import (
